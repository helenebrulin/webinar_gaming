...
func main() {
	...
	redisHost := getopt.StringLong("host", 's', "redis-12000.internal.helene-eu-cluster.demo.redislabs.com", "Redis Host")
	redisPort := getopt.IntLong("port", 'p', 12000, "Redis Port")
